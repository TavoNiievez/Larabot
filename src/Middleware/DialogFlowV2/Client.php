...
namespace Larabot\Middleware\DialogFlowV2;
...
use Larabot\Middleware\DialogFlowV2\Exception\DialogFlowV2NoIntentException;
use Larabot\Middleware\DialogFlowV2\Exception\DialogFlowV2NoResultException;
